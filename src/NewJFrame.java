...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        itemName.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ice cream", "Pudding", "Watalappan", "Milk Shake" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String qty=quan.getText();
        Double fullTotal=Double.valueOf(jLabel8.getText() );
        //String fullTotal=jLabel8.getText();
        Double total1=(Double.valueOf(price))*(Double.valueOf(qty));
        jLabel5.setText(total1.toString());
        DefaultTableModel dtm=(DefaultTableModel) jTable2.getModel();
        dtm.addRow(new Object[] {item, price, qty, total1});
        fullTotal+=total1;
        jLabel8.setText(fullTotal.toString());
        Price.setText("");
        quan.setText("");
        jLabel5.setText("0");
        } catch (Exception e) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String full_total=jTable2.getValueAt(row, 3).toString();
        Double fullTotal=Double.valueOf(jLabel8.getText() );
        fullTotal-=Double.valueOf(full_total);
        jLabel8.setText(fullTotal.toString());        
        DefaultTableModel dtm=(DefaultTableModel) jTable2.getModel();
        dtm.removeRow(row);
        } catch (Exception e) {
